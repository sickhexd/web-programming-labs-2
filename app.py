...
def books():
    schedule = [
        ...
        {'author': 'Сборник ', 'name': 'Зоопарк в твоей голове ', 'genre': 'Роман ', 'pages': '431 стр. '},
        {'author': 'Кай Берд ', 'name': 'Оппенгеймер ', 'genre': 'Роман ', 'pages': '300 стр. '},
        {'author': 'Джули Оцука ', 'name': 'Пловцы ', 'genre': 'Роман ', 'pages': '112 стр. '},
